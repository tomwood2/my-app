...
// the promise function uses object destructuring syntax to set
// 2 arguments, value and fail to defaults if the caller provides
// and object with only 1 of properties.  If the user calls this
// function like: promise() the object passed would be undefined
// so we use = {} to provide a default value for the object itself
